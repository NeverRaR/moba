...
struct FBaseProperty
{
	...
	UPROPERTY(EditAnywhere)
		float MoneyWorth = 300.0f;

	UPROPERTY(EditAnywhere)
		float MoneyWorthGrowth = 15.0f;

	UPROPERTY(EditAnywhere)
		float EXPWorth = 50.0f;
...
public:
	...
	UFUNCTION(BlueprintCallable)
		float GetCurMoney() { return FCurPropertyDetail.Money; }

	UFUNCTION(BlueprintCallable)
		float SetMoney(float NewMoney) { return FCurPropertyDetail.Money = NewMoney; }

	UFUNCTION(BlueprintCallable)
		float AddMoney(float DeltaMoney) { return FCurPropertyDetail.Money += DeltaMoney; }

	UFUNCTION(BlueprintCallable)
		float GetMoneyWorth() { return FBasePropertyDetail.MoneyWorth; }

	UFUNCTION(BlueprintCallable)
		float SetMoneyWorth(float NewMoneyWorth) { return FBasePropertyDetail.MoneyWorth = NewMoneyWorth; }

	UFUNCTION(BlueprintCallable)
		float AddMoneyWorth(float DeltaMoneyWorth) { return FBasePropertyDetail.MoneyWorth += DeltaMoneyWorth; }

	UFUNCTION(BlueprintCallable)
		float GetEXPWorth() { return FBasePropertyDetail.EXPWorth; }

	UFUNCTION(BlueprintCallable)
		float SetEXPWorth(float NewEXPWorth) { return FBasePropertyDetail.EXPWorth = NewEXPWorth; }

	UFUNCTION(BlueprintCallable)
		float AddEXPWorth(float DeltaEXPWorth) { return FBasePropertyDetail.EXPWorth += DeltaEXPWorth; }

	UFUNCTION(BlueprintCallable)
		float GetEXPWorthGrowth() { return FBasePropertyDetail.EXPWorthGrowth; }

	UFUNCTION(BlueprintCallable)
		float GetMoneyWorthGrowth() { return FBasePropertyDetail.MoneyWorthGrowth; }
	...
	UFUNCTION(BlueprintCallable)
		float GetAttackRange() { return FBasePropertyDetail.AttackRange; }
	
	UFUNCTION(BlueprintCallable)
		float GetAttackedRange() { return FBasePropertyDetail.AttackedRange; }

	//KDA
	UFUNCTION(BlueprintCallable)
		float GetCurKillNum() { return FCurPropertyDetail.KillNum; }

	UFUNCTION(BlueprintCallable)
		float SetKillNum(float NewKillNum) { return FCurPropertyDetail.KillNum = NewKillNum; }

	UFUNCTION(BlueprintCallable)
		float AddKillNum(float DeltaKillNum) { return FCurPropertyDetail.KillNum += DeltaKillNum; }

	UFUNCTION(BlueprintCallable)
		float GetCurDeathNum() { return FCurPropertyDetail.DeathNum; }

	UFUNCTION(BlueprintCallable)
		float SetDeathNum(float NewDeathNum) { return FCurPropertyDetail.DeathNum = NewDeathNum; }

	UFUNCTION(BlueprintCallable)
		float AddDeathNum(float DeltaDeathNum) { return FCurPropertyDetail.DeathNum += DeltaDeathNum; }


	UFUNCTION(BlueprintCallable)
		float GetCurAidNum() { return FCurPropertyDetail.AidNum; }

	UFUNCTION(BlueprintCallable)
		float SetAidNum(float NewAidNum) { return FCurPropertyDetail.AidNum = NewAidNum; }
